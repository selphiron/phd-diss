...
\subsubsection{Categorizing Cyclists by Velocity}
...
\begin{figure*}[t]
    %\vspace{-3em}
    \centering
    \subfloat[All cyclists]{\includegraphics[width=\columnwidth]{fig/analysis_max_acceleration_dist_fit_all.pdf}\label{fig:analysis_max_acceleration_dist_fit_all}}
    \hfill
    \subfloat[\num{3} cyclist groups: slow ($s$), medium ($m$), and fast ($f$)]{\includegraphics[width=\columnwidth]{fig/analysis_max_acceleration_dist_fit_groups.pdf}\label{fig:analysis_max_acceleration_dist_fit_groups}}
    \caption{%
...
\begin{figure*}[t]
    \centering
    \subfloat[All cyclists]{\includegraphics[width=\columnwidth]{fig/analysis_max_deceleration_dist_fit_all.pdf}\label{fig:analysis_max_deceleration_dist_fit_all}}
    \hfill
    \subfloat[\num{3} cyclist groups: slow ($s$), medium ($m$), and fast ($f$)]{\includegraphics[width=\columnwidth]{fig/analysis_max_deceleration_dist_fit_groups.pdf}\label{fig:analysis_max_deceleration_dist_fit_groups}}
    \caption{%
...
For analyzing cyclist deceleration, we extracted deceleration maneuvers from the dataset (see \cref{sec:analysis_acceleration}).
...
\begin{figure*}[t]
    %\vspace{-3em}
    \centering
    \subfloat[All cyclists]{\includegraphics[width=\columnwidth]{fig/analysis_max_velo_dist_fit_all.pdf}\label{fig:analysis_max_velo_dist_fit_all}}
    \hfill
    \subfloat[\num{3} cyclist groups: slow ($s$), medium ($m$), and fast ($f$)]{\includegraphics[width=\columnwidth]{fig/analysis_max_velo_dist_fit_groups.pdf}\label{fig:analysis_max_velo_dist_fit_groups}}
    \caption{%
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{fig/analysis_im_loc_default.pdf}
    \caption{%
...
\begin{figure*}[t]
    \vspace{-1.5em}
    \centering
    \subfloat[All cyclists]{\includegraphics[width=\columnwidth]{fig/eval_acc_all.pdf}\label{fig:eval_acc_all}}
    \hfill
    \subfloat[Only cyclist group slow ($s$)]{\includegraphics[width=\columnwidth]{fig/eval_acc_slow.pdf}\label{fig:eval_acc_slow}}
    \caption{%
...
\begin{figure*}[t]
    %\vspace{-3em}
    \centering
    \subfloat[All cyclists]{\includegraphics[width=\columnwidth]{fig/eval_dec_all.pdf}\label{fig:eval_dec_all}}
    \hfill
    \subfloat[Only cyclist group medium ($m$)]{\includegraphics[width=\columnwidth]{fig/eval_dec_medium.pdf}\label{fig:eval_dec_medium}}
    \caption{%
...
\begin{figure*}[t]
    \centering
    \subfloat[All cyclists]{\includegraphics[width=\columnwidth]{fig/eval_velo_all.pdf}\label{fig:eval_velo_all}}
    \hfill
    \subfloat[Only cyclist group fast ($f$)]{\includegraphics[width=\columnwidth]{fig/eval_velo_fast.pdf}\label{fig:eval_velo_fast}}
    \caption{%
...
\begin{figure*}[t]
    \centering
    \subfloat[Only cyclist group slow ($s$)]{\includegraphics[width=.3\textwidth]{fig/eval_im_loc_im_slow.pdf}\label{fig:eval_im_traj_slow}}
    \hfill
    \subfloat[Only cyclist group medium ($m$)]{\includegraphics[width=.3\textwidth]{fig/eval_im_loc_im_medium.pdf}\label{fig:eval_im_traj_medium}}
    \hfill
    \subfloat[Only cyclist group fast ($f$)]{\includegraphics[width=.3\textwidth]{fig/eval_im_loc_im_fast.pdf}\label{fig:eval_im_traj_fast}}
    \caption{%
...
\subsection{Related Work of Bicycle Simulation for SUMO}
