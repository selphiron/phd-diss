\section{Deriving Road Surface Quality from Bicycle Ride Data}
...
\begin{figure}[t]
    %\vspace{-3em}
    \centering
    \subfloat[Smooth cobblestones]{\includegraphics{fig/cobblestone.jpg}}
    \hfill
    \subfloat[Rough asphalt]{\includegraphics{fig/asphalt.jpg}}
    \caption{%
