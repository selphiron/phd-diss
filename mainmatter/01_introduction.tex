...
\subsection{SimRa: A Platform for Collecting Cycling Trip Data and Detecting Near Miss Incidents in Bicycle Traffic}
...
There, we also describe CycleSense, our deep learning model to automatically detect incidents from cycling trip data (\Cref{cha:cyclesense}).
