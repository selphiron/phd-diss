...
Reports published by the European Environment Agency of the European Union and the \ac{ipcc} indicate that transportation is one of the categories with substantial CO2 emissions~\cite{lee2023climate2}:
...
We have published this contribution in~\cite{karakaya2020simra,karakaya2023cyclesense}.
...
Third, we present how we improve the existing cyclist model of the urban traffic simulation software SUMO (\Cref{cha:sumo}).
