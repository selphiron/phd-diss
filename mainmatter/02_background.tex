...
These can be differentiated into two categories: traffic crashes with other participants, and unilateral accidents, such as falling from the bike due to losing balance or slipping in winter conditions.

\subsection*{Traffic Crashes}


\subsection*{Unilateral Accidents}
In their study, Juhra et al. investigate bicycle accidents, that were not reported to the police by analyzing hospitalization reports, where the patient was admitted after a bicycle accident~\cite{juhra2012bicycle}.
This is a good way to study unilateral accidents, since these are usually not reported to the police.
According to the study, the most common form of the unilateral accident is falling from the bicycle without external forces.
Reportedly, most of these accidents happen to children, probably due to their inexperience, and the elderly, probably due to the tolls of the age on the human body.
