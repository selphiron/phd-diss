...
\begin{itemize}
	...
	\item We describe how we integrate this data processing pipeline in the existing crowdsourcing project SimRa (See \Cref{sec:simra}) which previously only focused on incidents.
